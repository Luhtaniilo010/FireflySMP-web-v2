...
// ------------------------------------------------------------------
// Firefly account / staff authentication
// ------------------------------------------------------------------
window.FireflyAuth = {
  user: null,
  has(permission) {
...
function setSignedOutState() {
  if (signInButton && signInHead && signInText) {
    ...
    signInHead.innerHTML = `
      <span class="mc-hair"></span>
      <span class="mc-eye mc-eye-left"></span>
      <span class="mc-eye mc-eye-right"></span>
      <span class="mc-mouth"></span>
    `;
